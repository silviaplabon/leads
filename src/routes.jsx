...
import './styles/customInputStyle.css'
            ...
            >
              <div style={{ display: "flex", flexDirection: "column" }}>
                {/* <CustomTypography
                  ...
                  textVal={"JAD GLOBAL"}
                ></CustomTypography> */}
             <img src={'https://jadglobal.ae/assets/images/JadGlobalLogoWhite.webp'} style={{padding:"1.5rem 8px 1rem 8px",width:'8em'}}/>  <CustomSidebar></CustomSidebar>
              </div>
            </Sider>
